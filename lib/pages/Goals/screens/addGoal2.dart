                  ...
                  _ActionButton(
                    ...
                    onPressed: () {
                      saveData(
                        ...
                        selectedCategory,
                        selectedReminder,
                        selectedGoalType, // Pass the parent's updated state
                      );
                    },
                  ),
...
class _CategoriesSelectorState extends State<_CategoriesSelector> {
  ...
  Future<void> _fetchCategories() async {
    final snapshot = await FirebaseFirestore.instance.collection('Categories').where('user_id', isEqualTo: FirebaseAuth.instance.currentUser?.uid).get();
    setState(() {
...
Future<void> saveData(
  ...
  try {
    ...
    if (subTitle.isEmpty || description.isEmpty || selectedCategory.isEmpty || selectedReminder.isEmpty || selectedGoalType.isEmpty || dueDates.isEmpty || dueDates.any((date) => date == null)) {
